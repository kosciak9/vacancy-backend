# Generated by Django 2.2 on 2019-04-20 17:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('locale', models.CharField(choices=[('en', 'English'), ('pl', 'Polski')], default='pl', max_length=2)),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, to='users.AdditionalPerk'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
